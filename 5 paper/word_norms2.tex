...
semantic feature production task), which were combined with the previous
...
variability or extent of associated information for a cue
({\textbf{???}}; {\textbf{???}}; {\textbf{???}}). Several studies have
showed the positive effects of semantic richness on semantic tasks based
on task demand ({\textbf{???}}; {\textbf{???}}; {\textbf{???}};
{\textbf{???}}), and thus, they were included as important variables to
examine.
