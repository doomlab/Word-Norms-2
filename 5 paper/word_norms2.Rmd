...
cor.table[7, ] = c("FSG", 0.06, 0.04, 0.08, 0.10, -0.15, 0.24, 1, " ")
...
## Semantic Priming Prediction 

```{r divergent-calculate, eval=FALSE, include=FALSE}
