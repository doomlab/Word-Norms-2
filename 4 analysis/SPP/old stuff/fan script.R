...
model3 = lm(NT.200ms.RT ~ PLength + TLength + POrthoN + TOrthoN + 
...
model4 = lm(NT.200ms.RT ~ PLength + TLength + POrthoN + TOrthoN + 
              PSubFreq + PPOS + TPOS + TSubFreq +
              nomiss$BAS + nomiss$FAS + nomiss$CueFanOut + 
              nomiss$TargetFanIn + nomiss$PCosine_Set + 
              nomiss$TCosine_Set + 
...
##third step (semantics)
model7 = lm(NT.1200ms.RT ~ PLength + TLength + POrthoN + TOrthoN + 
              PSubFreq + PPOS + TPOS + TSubFreq +
              nomiss$BAS + nomiss$FAS + nomiss$CueFanOut + 
              nomiss$TargetFanIn + nomiss$PCosine_Set + 
              nomiss$TCosine_Set + 
...
##fourth step (thematics)
model8 = lm(NT.1200ms.RT ~ PLength + TLength + POrthoN + TOrthoN + 
              PSubFreq + PPOS + TPOS + TSubFreq +
              nomiss$BAS + nomiss$FAS + nomiss$CueFanOut + 
              nomiss$TargetFanIn + nomiss$PCosine_Set + 
              nomiss$TCosine_Set + 
...
##third step (semantics)
model11 = lm(NT.200ms.RT.Priming ~ PLength + TLength + POrthoN + TOrthoN + 
               PSubFreq + PPOS + TPOS + TSubFreq +
               nomiss$BAS + nomiss$FAS + nomiss$CueFanOut + 
               nomiss$TargetFanIn + nomiss$PCosine_Set + 
               nomiss$TCosine_Set + 
...
##fourth step (thematics)
model12 = lm(NT.200ms.RT.Priming ~ PLength + TLength + POrthoN + TOrthoN + 
               PSubFreq + PPOS + TPOS + TSubFreq +
               nomiss$BAS + nomiss$FAS + nomiss$CueFanOut + 
               nomiss$TargetFanIn + nomiss$PCosine_Set + 
               nomiss$TCosine_Set + 
...
##third step (semantics)
model15 = lm(NT.200ms.RT.Priming ~ PLength + TLength + POrthoN + TOrthoN + 
               PSubFreq + PPOS + TPOS + TSubFreq +
               nomiss$BAS + nomiss$FAS + nomiss$CueFanOut + 
               nomiss$TargetFanIn + nomiss$PCosine_Set + 
               nomiss$TCosine_Set + 
...
##fourth step (thematics)
model16 = lm(NT.200ms.RT.Priming ~ PLength + TLength + POrthoN + TOrthoN + 
               PSubFreq + PPOS + TPOS + TSubFreq +
               nomiss$BAS + nomiss$FAS + nomiss$CueFanOut + 
               nomiss$TargetFanIn + nomiss$PCosine_Set + 
               nomiss$TCosine_Set + 
